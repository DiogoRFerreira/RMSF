...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b2d2dd82020, const void *arg_0x2b2d2dd82320);
#line 780
__extension__ 
#line 797
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2b2d2e069d50), 
int (*key_eq_fn)(void *arg_0x2b2d2e068550, void *arg_0x2b2d2e068810));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b2d2e2893f0, int arg_0x2b2d2e289670);
static inline double RandomUniform(void );
...
# 63 "/opt/tinyos-2.1.2/tos/lib/tossim/CpmModelC.nc"
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b2d2e697a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b2d2e697a50, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b2d2e698e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b2d2e698e30, msg, payload, len);
#line 78
...
# 316 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$Control$default$startDone(error_t err)
#line 316
{
  return;
...
# 220 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$AMSend$default$sendDone(uint8_t id, message_t *msg, error_t err)
#line 220
{
  return;
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b2d2e6a1c70, message_t * msg, error_t error){
#line 110
    TossimActiveMessageC$AMSend$default$sendDone(arg_0x2b2d2e6a1c70, msg, error);
#line 110
}
#line 110
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b2d2e396020){
#line 75
  switch (arg_0x2b2d2e396020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b2d2e396020);
#line 75
      break;
#line 75
    }
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b2d2eb37950){
#line 83
  switch (arg_0x2b2d2eb37950) {
#line 83
    case 0U:
#line 83
      BlinkC$Timer0$fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b2d2eb37950);
#line 83
      break;
#line 83
    }
