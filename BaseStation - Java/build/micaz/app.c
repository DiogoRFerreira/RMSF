...
extern int memcmp(const void *arg_0x2afc6f1d9020, const void *arg_0x2afc6f1d9320, size_t arg_0x2afc6f1d95e0) __attribute((__pure__)) ;
extern void *memcpy(void *arg_0x2afc6f1e0020, const void *arg_0x2afc6f1e0320, size_t arg_0x2afc6f1e05e0);



extern void *memset(void *arg_0x2afc6f1e3150, int arg_0x2afc6f1e33d0, size_t arg_0x2afc6f1e3690);
...
typedef int (*__compar_fn_t)(const void *arg_0x2afc6f201970, const void *arg_0x2afc6f201c70);
...
static void TestSerialC__AMControl__startDone(error_t error);
#line 138
static void TestSerialC__AMControl__stopDone(error_t error);
...
error_t error);
#line 110
static void TestSerialC__AMSendRadio__sendDone(
#line 103
message_t * msg, 
...
static void TestSerialC__uartSendTask__runTask(void );
...
static void TestSerialC__UartSend__sendDone(
#line 96
message_t * msg, 
...
TestSerialC__RadioSnoop__receive(
# 76 "TestSerialC.nc"
am_id_t arg_0x2afc6f3fa500, 
# 71 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
# 31 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
static uint8_t SerialPacketInfo802_15_4P__Info__upperLength(message_t *msg, uint8_t dataLinkLen);
#line 15
static uint8_t SerialPacketInfo802_15_4P__Info__offset(void );
...
static uint8_t SerialPacketInfo802_15_4P__Info__dataLinkLength(message_t *msg, uint8_t upperLen);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t TestSerialC__AMControl__start(void );
#line 104
...
uint8_t len);
#line 80
static error_t TestSerialC__AMSendRadio__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
static uint8_t TestSerialC__RadioPacket__payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
TestSerialC__RadioPacket__getPayload(
#line 121
message_t * msg, 
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t TestSerialC__uartSendTask__postTask(void );
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
static 
#line 123
void * 
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
static void TestSerialC__Leds__led0Toggle(void );
...
static void TestSerialC__Leds__led1Toggle(void );
#line 100
...
TestSerialC__RadioPacketSend__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t TestSerialC__UartSend__send(
#line 67
message_t * msg, 
...
uint8_t len);
# 129 "TestSerialC.nc"
enum TestSerialC____nesc_unnamed4337 {
#line 129
  TestSerialC__uartSendTask = 0U
};
#line 129
typedef int TestSerialC____nesc_sillytask_uartSendTask[TestSerialC__uartSendTask];
#line 88
enum TestSerialC____nesc_unnamed4338 {
  TestSerialC__UART_QUEUE_LEN = 12, 
  TestSerialC__RADIO_QUEUE_LEN = 12
};
...
uint16_t TestSerialC__node_id;


bool TestSerialC__G_buzzer_enabled = TRUE;
bool TestSerialC__G_motion_enabled = TRUE;
bool TestSerialC__G_propagation_effect_enabled = TRUE;

uint16_t TestSerialC__Down_node_id;
bool TestSerialC__Down_base_station;
bool TestSerialC__Down_buzzer_off;



bool TestSerialC__Down_propagation_effect_enabled;
bool TestSerialC__Down_motion_detected = 1;
#line 123
message_t TestSerialC__uartQueueBufs[TestSerialC__UART_QUEUE_LEN];
message_t * TestSerialC__uartQueue[TestSerialC__UART_QUEUE_LEN];
uint8_t TestSerialC__uartIn;
#line 125
uint8_t TestSerialC__uartOut;
bool TestSerialC__uartBusy;
#line 126
bool TestSerialC__uartFull;




static inline void TestSerialC__dropBlink(void );



static inline void TestSerialC__failBlink(void );
...
#line 154
static inline void TestSerialC__RadioControl__startDone(error_t error);


static inline void TestSerialC__SerialControl__startDone(error_t error);





static inline void TestSerialC__SerialControl__stopDone(error_t error);
static inline void TestSerialC__RadioControl__stopDone(error_t error);


uint8_t TestSerialC__radio_msg_rcv = 0;

static message_t * TestSerialC__receive(message_t * msg, void *payload, uint8_t len);

static inline message_t *TestSerialC__RadioSnoop__receive(am_id_t id, message_t *msg, void *payload, uint8_t len);



static inline message_t *TestSerialC__RadioReceive__receive(am_id_t id, message_t *msg, void *payload, uint8_t len);



static message_t *TestSerialC__receive(message_t *msg, void *payload, uint8_t len);
#line 209
uint8_t TestSerialC__tmpLen;

static inline void TestSerialC__uartSendTask__runTask(void );
#line 266
static inline void TestSerialC__MilliTimer__fired(void );
#line 306
static inline void TestSerialC__UartSend__sendDone(message_t *msg, error_t error);
#line 322
...
static inline void TestSerialC__AMControl__startDone(error_t err);
...
static inline void TestSerialC__AMControl__stopDone(error_t err);

static inline void TestSerialC__AMSendRadio__sendDone(message_t *msg, error_t err);
# 42 "/opt/tinyos-2.1.2/tos/interfaces/GeneralIO.nc"
...
enum /*Counter32khz32C.Transform32*/TransformCounterC__1____nesc_unnamed4372 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.Transform32*/TransformAlarmC__0____nesc_unnamed4373 {
...
enum HplCC2420InterruptsP____nesc_unnamed4374 {
#line 69
...
enum /*Atm128SpiC.Arbiter.Queue*/FcfsResourceQueueC__1____nesc_unnamed4382 {
#line 49
...
enum /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0____nesc_unnamed4383 {
#line 69
...
message_t *msg);
# 59 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo802_15_4P.nc"
enum SerialPacketInfo802_15_4P____nesc_unnamed4398 {
  SerialPacketInfo802_15_4P__HEADER_SIZE = sizeof(cc2420_header_t ), 
  SerialPacketInfo802_15_4P__FOOTER_SIZE = sizeof(cc2420_footer_t )
};


static inline uint8_t SerialPacketInfo802_15_4P__Info__offset(void );


static inline uint8_t SerialPacketInfo802_15_4P__Info__dataLinkLength(message_t *msg, uint8_t upperLen);


static inline uint8_t SerialPacketInfo802_15_4P__Info__upperLength(message_t *msg, uint8_t dataLinkLen);
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 67
message_t * msg, 
...
static void /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 158
message_t * amsg, 
...
static error_t /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
#line 405
{
  if (&TestSerialC__packet == msg) {
      TestSerialC__locked = FALSE;
    }
}

# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  TestSerialC__AMSendRadio__sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x2afc707d42a0, message_t * msg, error_t error){
#line 100
  switch (arg_0x2afc707d42a0) {
#line 100
    case 0U:
#line 100
      /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x2afc707d42a0, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x2afc707d24d0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x2afc707d24d0, addr, msg, len);
#line 80
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x2afc706dcb30, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x2afc706dcb30, dest, msg);
#line 59
}
#line 59
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x2afc706db700, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x2afc706db700, msg);
#line 95
}
#line 95
...
#line 45
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool Atm128SpiP__ResourceArbiter__isOwner(uint8_t arg_0x2afc701bca60){
#line 128
  unsigned char __nesc_result;
#line 128

#line 128
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__isOwner(arg_0x2afc701bca60);
#line 128
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x2afc7028b020){
#line 59
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__default__configure(arg_0x2afc7028b020);
#line 59
}
#line 59
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x2afc7028e840){
#line 61
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x2afc7028e840);
#line 61
}
#line 61
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__immediateRequest(uint8_t arg_0x2afc701bca60){
#line 97
  unsigned char __nesc_result;
#line 97

#line 97
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__immediateRequest(arg_0x2afc701bca60);
#line 97
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__requested(uint8_t arg_0x2afc7028e840){
#line 53
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__default__requested(arg_0x2afc7028e840);
#line 53
}
#line 53
...
# 88 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__request(uint8_t arg_0x2afc701bca60){
#line 88
  unsigned char __nesc_result;
#line 88

#line 88
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__request(arg_0x2afc701bca60);
#line 88
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x2afc70668600){
#line 102
  switch (arg_0x2afc70668600) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x2afc70668600);
#line 102
      break;
#line 102
    }
...
#line 171
{
  return TestSerialC__receive(msg, payload, len);
}

# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x2afc706e0c40, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  __nesc_result = TestSerialC__RadioSnoop__receive(arg_0x2afc706e0c40, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x2afc706e0060, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  __nesc_result = TestSerialC__RadioReceive__receive(arg_0x2afc706e0060, msg, payload, len);
#line 78
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x2afc7028b020){
#line 65
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x2afc7028b020);
#line 65
}
#line 65
# 68 "/opt/tinyos-2.1.2/tos/system/FcfsResourceQueueC.nc"
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__release(uint8_t arg_0x2afc701bca60){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__release(arg_0x2afc701bca60);
#line 120
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void Atm128SpiP__Resource__granted(uint8_t arg_0x2afc70195380){
#line 102
  switch (arg_0x2afc70195380) {
#line 102
    case 0U:
#line 102
...
#line 102
    default:
#line 102
      Atm128SpiP__Resource__default__granted(arg_0x2afc70195380);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__granted(uint8_t arg_0x2afc7028f4f0){
#line 102
  Atm128SpiP__ResourceArbiter__granted(arg_0x2afc7028f4f0);
#line 102
}
#line 102
...
# 71 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x2afc7012b6e0, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x2afc7012b6e0) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x2afc7012b6e0, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x2afc706db700, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x2afc706db700, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x2afc7012b6e0, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x2afc7012b6e0) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x2afc7012b6e0, data, length, error);
#line 91
      break;
#line 91
    }
...
# 88 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x2afc706db700, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x2afc706db700, msg);
#line 88
}
#line 88
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x2afc700ea360){
#line 102
  switch (arg_0x2afc700ea360) {
#line 102
...
#line 102
    default:
#line 102
      CC2420SpiP__Resource__default__granted(arg_0x2afc700ea360);
#line 102
      break;
#line 102
    }
...
#line 100
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x2afc706e4ce0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x2afc706e4ce0, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
#line 138
  TestSerialC__AMControl__stopDone(error);
#line 138
}
#line 138
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t TestSerialC__AMControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 113
  TestSerialC__AMControl__startDone(error);
#line 113
}
#line 113
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
#line 266
{
  ...
  if (TestSerialC__radio_msg_rcv) {
      ...
      if (TestSerialC__locked) {
          ...
          RadioMsg *rcm = (RadioMsg *)TestSerialC__SerialPacket__getPayload(&TestSerialC__packet, sizeof(RadioMsg ));
...
#line 278
          if (TestSerialC__SerialPacket__maxPayloadLength() < sizeof(RadioMsg )) {
              return;
            }

          __nesc_hton_uint16(rcm->counter.nxdata, TestSerialC__counter);
          __nesc_hton_uint16(rcm->node_id.nxdata, TestSerialC__Down_node_id);
          __nesc_hton_int8(rcm->base_station.nxdata, TestSerialC__Down_base_station);
          __nesc_hton_int8(rcm->buzzer_off.nxdata, FALSE);
          __nesc_hton_int8(rcm->buzzer_enabled.nxdata, TestSerialC__G_buzzer_enabled);
          __nesc_hton_int8(rcm->motion_enabled.nxdata, TestSerialC__G_motion_enabled);
          __nesc_hton_int8(rcm->propagation_effect_enabled.nxdata, TestSerialC__Down_propagation_effect_enabled);
          __nesc_hton_int8(rcm->motion_detected.nxdata, TestSerialC__Down_motion_detected);


          if (TestSerialC__AMSend__send(AM_BROADCAST_ADDR, &TestSerialC__packet, sizeof(RadioMsg )) == SUCCESS) {
              TestSerialC__locked = TRUE;
            }
        }

      TestSerialC__radio_msg_rcv = 0;
    }
  else 
#line 298
    {
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2afc6fbea3f0){
#line 83
  switch (arg_0x2afc6fbea3f0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2afc6fbea3f0);
#line 83
      break;
#line 83
    }
...
# 68 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo802_15_4P.nc"
static inline uint8_t SerialPacketInfo802_15_4P__Info__dataLinkLength(message_t *msg, uint8_t upperLen)
#line 68
{
  return upperLen + SerialPacketInfo802_15_4P__HEADER_SIZE + SerialPacketInfo802_15_4P__FOOTER_SIZE;
}
...
# 23 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x2afc6f7dfe30, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x2afc6f7dfe30) {
#line 23
...
#line 23
      __nesc_result = SerialPacketInfo802_15_4P__Info__dataLinkLength(msg, upperLen);
#line 23
      break;
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x2afc6f7dfe30, msg, upperLen);
#line 23
      break;
#line 23
    }
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x2afc6f69cb10, message_t * msg, error_t error){
#line 110
  switch (arg_0x2afc6f69cb10) {
#line 110
...
#line 110
    default:
#line 110
      /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__default__sendDone(arg_0x2afc6f69cb10, msg, error);
#line 110
      break;
#line 110
    }
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t TestSerialC__uartSendTask__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(TestSerialC__uartSendTask);
#line 67
...
{
  if (error != SUCCESS) {
    TestSerialC__failBlink();
    }
  else {
#line 310
    { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
      if (msg == TestSerialC__uartQueue[TestSerialC__uartOut]) 
        {
          if (++TestSerialC__uartOut >= TestSerialC__UART_QUEUE_LEN) {
            TestSerialC__uartOut = 0;
            }
#line 315
          if (TestSerialC__uartFull) {
            TestSerialC__uartFull = FALSE;
            }
        }
#line 318
      __nesc_atomic_end(__nesc_atomic); }
...
#line 318
  TestSerialC__uartSendTask__postTask();
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x2afc6f7c19c0, message_t * msg, error_t error){
#line 100
  switch (arg_0x2afc6f7c19c0) {
#line 100
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 100
...
#line 100
    case TOS_SERIAL_802_15_4_ID:
#line 100
      TestSerialC__UartSend__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x2afc6f7c19c0, msg, error);
#line 100
      break;
#line 100
    }
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t TestSerialC__AMSendRadio__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 80
...
inline static void TestSerialC__Leds__led1Toggle(void ){
#line 83
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * TestSerialC__RadioPacketSend__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
void *payload, uint8_t len)
{
  if (!TestSerialC__locked) {
      if (len != sizeof(RadioMsg )) {
          ...
          RadioMsg *smsg = 
          (RadioMsg *)TestSerialC__RadioPacketSend__getPayload(&TestSerialC__packet, sizeof(RadioMsg ));

#line 338
          __nesc_hton_uint16(smsg->node_id.nxdata, __nesc_ntoh_uint16(rmsg->node_id.nxdata));
          __nesc_hton_int8(smsg->base_station.nxdata, TRUE);
          __nesc_hton_int8(smsg->buzzer_enabled.nxdata, TestSerialC__G_buzzer_enabled = __nesc_ntoh_int8(rmsg->buzzer_enabled.nxdata) != 0);
          __nesc_hton_int8(smsg->motion_enabled.nxdata, TestSerialC__G_motion_enabled = __nesc_ntoh_int8(rmsg->motion_enabled.nxdata) != 0);
          __nesc_hton_int8(smsg->propagation_effect_enabled.nxdata, TestSerialC__G_propagation_effect_enabled = __nesc_ntoh_int8(rmsg->propagation_effect_enabled.nxdata) != 0);
          __nesc_hton_int8(smsg->buzzer_off.nxdata, __nesc_ntoh_int8(rmsg->buzzer_off.nxdata));
          __nesc_hton_int8(smsg->motion_detected.nxdata, FALSE);
          __nesc_hton_int8(smsg->tone_detected.nxdata, FALSE);
          __nesc_hton_int8(smsg->enabled.nxdata, __nesc_ntoh_int8(rmsg->enabled.nxdata) != 0);
          TestSerialC__Leds__led1Toggle();



          if (
#line 350
          TestSerialC__AMSendRadio__send(AM_BROADCAST_ADDR, 
          &TestSerialC__packet, sizeof(RadioMsg )) == SUCCESS) {
              TestSerialC__locked = TRUE;
            }
        }
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x2afc6f699d10, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2afc6f699d10) {
#line 78
    case AM_TEST_SERIAL_MSG:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x2afc6f699d10, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x2afc6f7c4da0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2afc6f7c4da0) {
#line 78
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x2afc6f7c4da0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 71 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo802_15_4P.nc"
static inline uint8_t SerialPacketInfo802_15_4P__Info__upperLength(message_t *msg, uint8_t dataLinkLen)
#line 71
{
  return dataLinkLen - (SerialPacketInfo802_15_4P__HEADER_SIZE + SerialPacketInfo802_15_4P__FOOTER_SIZE);
}
...
# 31 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x2afc6f7dfe30, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    case TOS_SERIAL_802_15_4_ID:
#line 31
      __nesc_result = SerialPacketInfo802_15_4P__Info__upperLength(msg, dataLinkLen);
#line 31
      break;
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x2afc6f7dfe30, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 65 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo802_15_4P.nc"
static inline uint8_t SerialPacketInfo802_15_4P__Info__offset(void )
#line 65
{
  return sizeof(message_header_t ) - SerialPacketInfo802_15_4P__HEADER_SIZE;
}
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x2afc6f7dfe30){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    case TOS_SERIAL_802_15_4_ID:
#line 15
      __nesc_result = SerialPacketInfo802_15_4P__Info__offset();
#line 15
      break;
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x2afc6f7dfe30);
#line 15
      break;
#line 15
    }
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
{
  if (err == SUCCESS) {
      TestSerialC__MilliTimer__startPeriodic(100);
    }
}
...
#line 40
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t TestSerialC__UartSend__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void TestSerialC__Leds__led0Toggle(void ){
#line 67
...
#line 72
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * TestSerialC__RadioPacket__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
#line 78
inline static uint8_t TestSerialC__RadioPacket__payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 215
    {
      if (TestSerialC__uartIn == TestSerialC__uartOut && !TestSerialC__uartFull) {
          TestSerialC__uartBusy = FALSE;
          {
#line 218
            __nesc_atomic_end(__nesc_atomic); 
#line 218
...
#line 221
    __nesc_atomic_end(__nesc_atomic); }
  msg = TestSerialC__uartQueue[TestSerialC__uartOut];
  TestSerialC__tmpLen = len = TestSerialC__RadioPacket__payloadLength(msg);

  rcm = (RadioMsg *)TestSerialC__RadioPacket__getPayload(msg, sizeof(RadioMsg ));
  TestSerialC__Down_node_id = __nesc_ntoh_uint16(rcm->node_id.nxdata);
  TestSerialC__Down_buzzer_off = __nesc_ntoh_int8(rcm->buzzer_off.nxdata);
  TestSerialC__Down_motion_detected = __nesc_ntoh_int8(rcm->motion_detected.nxdata);



  if (__nesc_ntoh_int8(
#line 231
  rcm->motion_detected.nxdata) == TRUE && TestSerialC__G_motion_enabled == TRUE && TestSerialC__G_buzzer_enabled == TRUE
   && (__nesc_ntoh_uint16(rcm->node_id.nxdata) == 1 || __nesc_ntoh_uint16(rcm->node_id.nxdata) == 2)) {
...
#line 237
          __nesc_hton_int8(smsg->base_station.nxdata, TRUE);
          __nesc_hton_int8(smsg->motion_detected.nxdata, TRUE);
          __nesc_hton_uint16(smsg->node_id.nxdata, 100);
#line 239
          ;
          __nesc_hton_int8(smsg->buzzer_enabled.nxdata, TestSerialC__G_buzzer_enabled);
          __nesc_hton_int8(smsg->buzzer_off.nxdata, FALSE);
...
#line 249
  ...
  TestSerialC__node_id = __nesc_ntoh_uint16(rcm->node_id.nxdata);

  if (TestSerialC__UartSend__send(TestSerialC__uartQueue[TestSerialC__uartOut], len) == SUCCESS) {

      TestSerialC__radio_msg_rcv = 1;
    }
  else {
      TestSerialC__failBlink();
      TestSerialC__uartSendTask__postTask();
...
#line 140
{
  ...
  for (i = 0; i < TestSerialC__UART_QUEUE_LEN; i++) 
    TestSerialC__uartQueue[i] = &TestSerialC__uartQueueBufs[i];
  TestSerialC__uartIn = TestSerialC__uartOut = 0;
  TestSerialC__uartBusy = FALSE;
  TestSerialC__uartFull = TRUE;
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2afc6f333020){
#line 75
  switch (arg_0x2afc6f333020) {
#line 75
    case TestSerialC__uartSendTask:
#line 75
      TestSerialC__uartSendTask__runTask();
#line 75
      break;
#line 75
    case SerialP__RunTx:
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x2afc6f333020);
#line 75
      break;
#line 75
    }
      ...
      if (!TestSerialC__uartFull) 
        {
          ...
          ret = TestSerialC__uartQueue[TestSerialC__uartIn];
          TestSerialC__uartQueue[TestSerialC__uartIn] = msg;

          TestSerialC__uartIn = (TestSerialC__uartIn + 1) % TestSerialC__UART_QUEUE_LEN;

          if (TestSerialC__uartIn == TestSerialC__uartOut) {
            TestSerialC__uartFull = TRUE;
            }
          if (!TestSerialC__uartBusy) 
            {
              TestSerialC__uartSendTask__postTask();
              TestSerialC__uartBusy = TRUE;
            }
        }
      else {

          TestSerialC__dropBlink();
        }
    }
#line 204
    __nesc_atomic_end(__nesc_atomic); }
...
#line 55
{
  /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 6);
  return /*TestSerialAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}
